public class Contrato_pessoa_juridica:Contrato
{
    ...
    public Contrato_pessoa_juridica(string detalhes,string email, string telefone,string nome, string cnpj, string inscricao_estadual, string empresa, int prazo)
